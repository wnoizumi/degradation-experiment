...
public class SmellsOfPatterns {
	...
	public static final List<SmellName> CONCERN_OVERLOAD = Arrays.asList(SmellName.ComplexClass, SmellName.FeatureEnvy, SmellName.GodClass, SmellName.IntensiveCoupling, SmellName.LongMethod, SmellName.ShotgunSurgery);
	...
	public static final List<SmellName> SCATTERED_CONCERN_MANDATORY = Arrays.asList(SmellName.GodClass, SmellName.ComplexClass);
